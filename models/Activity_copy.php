...
//            ['title','match','pattern' => '/[a-z]{1,0}/iu'],
            [['file'], 'file', 'extensions' => ['jpg', 'png', 'gif'],'maxFiles' => 5, 'skipOnEmpty' => false],
            // [['file'], 'file', 'skipOnEmpty' => false, 'extensions' => 'png,jpg,gif', 'maxFiles' => 5, 'checkExtensionByMimeType'=>false],
        ];
    }
...
//    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'repeatType' => 'Укажите периодичность повторений',
